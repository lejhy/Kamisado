...
import model.DoubleSumo;
import model.Game;
import model.Piece;
import model.Player;
import model.Position;
import model.QuadrupleSumo;
...
public class GameViewController extends Controller {
	...
	public void roundOver(Value cause, String roundWinner) {
		...
		gc.fillText("Click to continue to next round", canvasWidth / 2, (canvasHeight + 3 * squareSize) / 2);
		gc.fillText(
				"\uD83E\uDC78 \uD83E\uDC70 \uD83E\uDC60 Fill from right or left? \uD83E\uDC62 \uD83E\uDC72 \uD83E\uDC7A",
				canvasWidth / 2, (canvasHeight + 5 * squareSize) / 2);
	}

	public void gameOver(Value cause, String roundWinner, String gameWinner) {
		drawRoundOver(cause, roundWinner);
		gc.setFont(new Font("Courier New", squareSize / 2));
		gc.fillText(gameWinner + " Won the Game!", canvasWidth / 2, (canvasHeight + 3 * squareSize) / 2);
	}

	public void gameOverDraw(Value cause, String roundWinner) {
		drawRoundOver(cause, roundWinner);
		gc.setFont(new Font("Courier New", squareSize / 2));
		gc.fillText("It's a DRAW!", canvasWidth / 2, (canvasHeight + 3 * squareSize) / 2);
	}
	...
	private void drawRoundOver(Value cause, String roundWinner) {
		...
		gc.fillText(gameOverCause, canvasWidth / 2, (canvasHeight - squareSize) / 2);
		gc.setFont(new Font("Avenir", squareSize / 2));
		gc.fillText(roundWinner + " won this round!", canvasWidth / 2, (canvasHeight + squareSize) / 2);
	}
			...
			case ORANGE:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(ORANGE_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(ORANGE_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(ORANGE_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(ORANGE_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(ORANGE_WHITE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(ORANGE_BLACK_ONE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(ORANGE_BLACK_TWO, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(ORANGE_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(ORANGE_BLACK_FOUR, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else
					gc.drawImage(ORANGE_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			case BLUE:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(BLUE_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(BLUE_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(BLUE_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(BLUE_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(BLUE_WHITE, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
								squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(BLUE_BLACK_ONE, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(BLUE_BLACK_TWO, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(BLUE_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(BLUE_BLACK_FOUR, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else
					gc.drawImage(BLUE_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			case PURPLE:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(PURPLE_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(PURPLE_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(PURPLE_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(PURPLE_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(PURPLE_WHITE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(PURPLE_BLACK_ONE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(PURPLE_BLACK_TWO, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(PURPLE_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(PURPLE_BLACK_FOUR, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else
					gc.drawImage(PURPLE_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			case PINK:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(PINK_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(PINK_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(PINK_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(PINK_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(PINK_WHITE, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
								squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(PINK_BLACK_ONE, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(PINK_BLACK_TWO, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(PINK_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(PINK_BLACK_FOUR, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else
					gc.drawImage(PINK_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			case YELLOW:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(YELLOW_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(YELLOW_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(YELLOW_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(YELLOW_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(YELLOW_WHITE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(YELLOW_BLACK_ONE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(YELLOW_BLACK_TWO, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(YELLOW_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(YELLOW_BLACK_FOUR, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else
					gc.drawImage(YELLOW_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			case RED:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(RED_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(RED_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(RED_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(RED_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(RED_WHITE, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
								squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(RED_BLACK_ONE, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(RED_BLACK_TWO, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(RED_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(RED_BLACK_FOUR, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				else
					gc.drawImage(RED_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			case GREEN:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(GREEN_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(GREEN_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(GREEN_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(GREEN_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(GREEN_WHITE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(GREEN_BLACK_ONE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(GREEN_BLACK_TWO, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(GREEN_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(GREEN_BLACK_FOUR, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else
					gc.drawImage(GREEN_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			case BROWN:
				if (piece.getPlayerPosition() == Value.BOTTOM)
					if (piece instanceof Sumo)
						gc.drawImage(BROWN_WHITE_ONE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof DoubleSumo)
						gc.drawImage(BROWN_WHITE_TWO, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof TripleSumo)
						gc.drawImage(BROWN_WHITE_THREE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else if (piece instanceof QuadrupleSumo)
						gc.drawImage(BROWN_WHITE_FOUR, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
					else
						gc.drawImage(BROWN_WHITE, piece.getPosition().x * squareSize,
								piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof Sumo)
					gc.drawImage(BROWN_BLACK_ONE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof DoubleSumo)
					gc.drawImage(BROWN_BLACK_TWO, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof TripleSumo)
					gc.drawImage(BROWN_BLACK_THREE, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else if (piece instanceof QuadrupleSumo)
					gc.drawImage(BROWN_BLACK_FOUR, piece.getPosition().x * squareSize,
							piece.getPosition().y * squareSize, squareSize, squareSize);
				else
					gc.drawImage(BROWN_BLACK, piece.getPosition().x * squareSize, piece.getPosition().y * squareSize,
							squareSize, squareSize);
				break;
			default:
				break;
	...
	public void update(Observable o, Object arg) {
		...
		if (game.isGameOver()) {
			if (game.hasNextRound())
				...
				if (overallWinner == null)
					...
					gameOver(game.getGameOverCause(), game.getRoundWinner().getName().get(),
							overallWinner.getName().get());
			}
		...
		if (!game.isGameOver() && game.getCurrentPlayer().getType() == Value.HUMAN
				&& game.getLastPlayer().getType() != Value.HUMAN) {
			undo.setVisible(true);
		} else {
			undo.setVisible(false);
		}
